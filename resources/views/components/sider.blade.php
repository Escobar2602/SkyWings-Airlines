...
<div id="sidebar-container" class="fixed inset-0 pointer-events-none z-[9999]">
    <div id="sidebar-overlay" class="absolute inset-0 hidden transition-opacity duration-300 ease-in-out pointer-events-auto bg-sky-900/50"></div>
        ...
        <div class="flex flex-col h-full px-3 py-4 text-white bg-gradient-to-br from-blue-800 to-purple-900">
            ...
            <ul id="sidebar-menu" class="flex-grow space-y-4 font-medium">
                ...
                <li>
                    <a href="{{ route('rutas') }}" onclick="rutas()"
                        ...
                        <span class="ml-3 transition-all duration-300 ease-in-out opacity-0 group-hover:text-white">Registro Rutas</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('tickets.search') }}" onclick="tickets.search()"
                        class="flex items-center p-2 transition-all duration-200 rounded-lg hover:bg-sky-700 group hover:scale-105">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z" />
                        </svg>
                        <span class="ml-3 transition-all duration-300 ease-in-out opacity-0 group-hover:text-white">Comprar Ticket</span>
                    </a>
                </li>
            </ul>
            ...
            <div class="mt-auto">
                <a href="{{ route('soporte') }}" onclick="soporte()"
                    ...
                    <span id="soporte-texto" class="ml-3 transition-all duration-300 ease-in-out opacity-0 group-hover:text-white">Soporte</span>
                </a>
            </div>
        </div>
    </aside>
