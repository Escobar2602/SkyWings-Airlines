...
<div id="sidebar-container" class="fixed inset-0 pointer-events-none z-[9999]">
    <div id="sidebar-overlay" class="absolute inset-0 hidden bg-sky-900/50 pointer-events-auto transition-opacity duration-300 ease-in-out"></div>
        ...
        <div class="flex flex-col h-full px-3 py-4 bg-gradient-to-br from-sky-800 to-blue-900 text-sky-100">
            ...
            <ul id="sidebar-menu" class="flex-grow space-y-4 font-medium">
                ...
                <li>
                    <a href="{{ route('rutas') }}" onclick="rutas()"
                        ...
                        <span class="ml-3 opacity-0 transition-all duration-300 ease-in-out group-hover:text-white">Registro Rutas</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('tiket') }}" onclick="tiket()"
                        ...
                        <span class="ml-3 opacity-0 transition-all duration-300 ease-in-out group-hover:text-white">Comprar Ticket</span>
                    </a>
                </li>
            </ul>
            ...
            <div class="mt-auto">
                <a href="{{ route('soporte') }}" onclick="soporte()"
                    ...
                    <span id="soporte-texto" class="ml-3 opacity-0 transition-all duration-300 ease-in-out group-hover:text-white">Soporte</span>
                </a>
            </div>
        </div>
    </aside>
...
<div class="fixed z-[10000] top-4 left-4">
    ...
    <label for="toggle-sidebar" class="flex flex-col items-center justify-center space-y-1 cursor-pointer w-7 h-7 bg-sky-700 rounded-md p-1 hover:bg-sky-600 transition-colors duration-200">
