...
<head>
    ...
    <title>Registro - SkyWings Airlines</title>
    ...
    <div class="register-container max-w-md w-full space-y-8 p-10 relative z-10">
        ...
        <form id="register-form" class="mt-8 space-y-6">
            ...
            <div class="step active" data-step="1">
                ...
                <div class="flex justify-end">
                    <button type="button" class="btn-primary next-step" data-next="2">
                        Siguiente <i class="fas fa-plane ml-2"></i>
                    </button>
                </div>
            </div>
            ...
            <div class="step" data-step="3">
                ...
                <div class="input-group">
                    <input id="passport" name="passport" type="text" required placeholder=" ">
                    <label for="passport">Número de pasaporte</label>
                </div>
                <div class="flex items-center mb-4">
                    <input id="terms" name="terms" type="checkbox" class="h-4 w-4 text-blue-500 focus:ring-blue-400 border-gray-300 rounded">
                    <label for="terms" class="ml-2 block text-sm text-gray-900">
                        Acepto los <a href="#" class="text-blue-500 hover:text-blue-400">términos y condiciones</a>
                    </label>
                </div>
                <div class="flex justify-between">
                    ...
                    <button type="submit" class="btn-primary">
                        Registrarse <i class="fas fa-paper-plane ml-2"></i>
                    </button>
                </div>
            </div>
        </form>
        ...
        <p class="mt-8 text-center text-sm text-gray-600">
            ...
            <a href="{{ route('login') }}" class="font-medium text-blue-500 hover:text-blue-400 transition duration-150 ease-in-out">
                Inicia sesión aquí
            </a>
        </p>
    </div>
